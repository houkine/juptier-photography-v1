...
const Layout = ({
    ...
    return (
        <div className="h-screen w-screen flex bg-white flex-col overflow-y-auto overflow-x-hidden scroll-smooth">
            <div className=' h-screen w-full flex flex-col' id='1'>
