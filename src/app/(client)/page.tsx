  ...
  return (
    <div className='h-screen flex flex-col'>
      ...
      <div className='flex flex-1 flex-col justify-center items-center text-gray-200'>
        ...
        <Link key={homeImageSrc[index].id+'3'} href={homeImageSrc[index].href} className='border-2 py-5 w-1/5 mt-10 flex justify-center text-sm tracking-wider opacity-60 hover:text-white hover:opacity-100 hover:font-bold animate-fadeIn_homeButton'>{homeImageSrc[index]?.href_content}</Link>
      </div>
