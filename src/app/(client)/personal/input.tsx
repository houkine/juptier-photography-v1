...
const Input = ({ label, value, onChange }: InputType) => {
    return (
        <div className=" mt-12 border-b-2 border-black/30 hover:border-black/60 focus-within:border-black/60 w-2/3 flex">
            <label htmlFor='e-mail' className="text-gray-300 text-xl tracking-wider">{label}</label>
            <input
